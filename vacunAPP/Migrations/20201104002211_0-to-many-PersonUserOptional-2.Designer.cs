...
namespace vacunAPP.Migrations
{
    ...
    [Migration("20201104002211_0-to-many-PersonUserOptional-2")]
    partial class _0tomanyPersonUserOptional2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vacunAPP.Core.Domain.Person", b =>
                {
                    b.HasOne("vacunAPP.Core.Domain.User", null)
                        .WithOne("Person")
            ...
            modelBuilder.Entity("vacunAPP.Core.Domain.User", b =>
                {
                    b.HasOne("vacunAPP.Core.Domain.Person", null)
                        .WithOne("User")
                        .HasForeignKey("vacunAPP.Core.Domain.User", "NIF")

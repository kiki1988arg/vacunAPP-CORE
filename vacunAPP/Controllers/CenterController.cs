...
namespace vacunAPP.Controllers
{
    ...
    public class CenterController : ControllerBase
    {
        ...
        public CenterController(IUnitOfWork unitOfWork, IMapper mapper)
        {
        ...
        [HttpGet]
        public async Task<IEnumerable<CenterViewModel>> Get()
        {            
            var InstituteList  = await this._unitOfWork.Institute.GetAll();
            IEnumerable<CenterViewModel> res = _mapper.Map<IEnumerable<Center>, IEnumerable<CenterViewModel>>(InstituteList);
            return res;           
